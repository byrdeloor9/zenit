...
export interface BudgetFormData {
  category: number
  amount: string
  months?: number | null  // Deprecated - kept for backwards compatibility
  start_date?: string  // Optional - backend will calculate
  end_date?: string | null  // Optional - backend will calculate
  is_indefinite?: boolean  // Deprecated - use is_recurring instead
  is_recurring?: boolean  // Monthly recurring budget
...
export const createBudget = async (data: BudgetFormData): Promise<Budget> => {
  ...
  // Backend calculates period_start and period_end automatically for monthly budgets
  const payload = {
